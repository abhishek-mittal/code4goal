...
//   }
  ...
  var str=addExp.splice(1,addExp.length-2).join('\n')
  let expExecu=experience(str)
  console.log(" 💛my experience execu returned array is :100:",expExecu);
...
//   console.log("In experience function ठठठठठठठठठठठठठठठठठठठठठठठ",exp)
//   fs.writeFile('./exp.json', JSON.stringify({ "data" : exp}))
//   if(exp !=null && exp != undefined)
//   {

//     var str=exp.splice(1,exp.length-2).join('\n')
//     console.log("In experience function ॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅॅ",str)
...
//    description=[description.toString().replace(/<[a-z]+>|<\/[a-z]+>|<[a-z]+\/>|&amp;|\t|\–|\-|\:|((([A-Za-z]+\s*\d{4}\s*[\-| ]\s*[a-z]*\s*)+\s*)|(\d{2}\s*[\/]\s*\d{4}\s*[\-]?[a-z]*\s*)+)(\(.*\))?|\n/gmi,'').replace(/`${regex}`/i,'').replace(/`${regex1}`/i,'').trim()]
//  description=description.filter(word => {
//   if(word!='')
//     return word;
